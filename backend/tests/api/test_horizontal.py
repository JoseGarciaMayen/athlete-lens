...
def test_analyze_horizontal_persists_to_database(client, db_session):
    ...
    response = client.post("/api/analyze/horizontal", data={"session_date": "2026-06-09", "jump_distance_cm": "264.5"})
...
def test_analyze_horizontal_invalid_date(client, db_session):
    ...
    response = client.post("/api/analyze/horizontal", data={"session_date": "not-a-date", "jump_distance_cm": "264.5"})
